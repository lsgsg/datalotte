...
import LotteItem from "../NoteItem/LotteItem";
import ShowChart_Lotte from "../NoteItem/ShowChart_Lotte"
...
const LotteList = ({ lChart }) => {

  const tableList = lChart.map((lChart1, i) => {
      console.log(lChart1.x + '여기는 LotteItem 전, LotteList')
      return <LotteItem lChart1={lChart1} key={lChart1.x} />;
  });
  const data = [
   {
     type: 'One',
        ...
        <div className = "note_chart">
           ...
           <div className={cx("table")}>
               ...
               <div className="tableIn">
                   <div className="content">{tableList}</div>
               </div>
